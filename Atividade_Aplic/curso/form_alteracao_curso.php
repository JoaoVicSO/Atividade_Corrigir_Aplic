...
<html>
	...
	<body>
		...
		<form action="alteracao_curso.php" 
			...
			<input type="hidden" name="id" value="<?php echo $cur["id_curso"];?>">
			<label for="ds_curso">

			Curso:
			</label>
			<input type="text" name="curso" id="ds_curso" value="<?php echo $cur["ds_curso"];?>">
			...
			<input type="text" name="carga_horaria" id="carga_horaria" value="<?php echo $cur["nr_carga_horaria"];?>">
			...
			<input type="text" name="data_inicio" id="data_inicio" value="<?php echo $cur["dt_inicio"];?>" >
